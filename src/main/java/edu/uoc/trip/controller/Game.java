...
public class Game {
    ...
    private boolean isFinished() {
        ...
        if(getCurrentLevel() == maxLevels){
            return false;
        }else if((getCurrentLevel() < maxLevels)){
            return true;
        }
            return false;
    }
    ...
    private void loadLevel() throws LevelException {
        int numberLevel =  getCurrentLevel() +1;
        String pathToFile = "levels/test/level" + numberLevel + ".txt";
        this.level = new Level(pathToFile);
        this.currentLevel +=1;
    ...
    public void reload() throws LevelException {
        //TODO
        int numberLevel =  getCurrentLevel();
        String pathToFile = "levels/test/level" + numberLevel + ".txt";
        this.level = new Level(pathToFile);
